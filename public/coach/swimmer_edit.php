...
if(is_post_request()) {
    ...
    $result = update_swimmer($swimmer,$user_data['id'],$squad_data['Id']);
  ...
  // display the blank form
    $edit_event = find_swimmer_by_id($id);
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Update Swimmer</p>
                                <?php echo display_errors($errors); ?>
                                <form action="<?php echo url_for("/coach/swimmer_edit.php"); ?>" method="post">

                                <h4>Edit Training Details </h4>
                                    <div>
