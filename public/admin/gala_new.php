...
if(is_post_request()) {
    ...
    $gala['name']        = $_POST['gala_name'] ?? '';
    $gala['location']    = $_POST['gala_location'] ?? '';
    $gala['date']        = $_POST['gala_date'] ?? '';
    $gala['time']        = $_POST['gala_time'] ?? '';
  ...
  $result = insert_gala_event($gala,$event);
  if($result === true) {
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form action="<?php echo url_for('/admin/gala_new.php'); ?>" method="post">

                                    <h4>Gala Details</h4>
                                    <dl>
                                        <dt>Name</dt>
                                        <dd><input type="text" name="gala_name" value="<?php echo h($gala['name']); ?>" /></dd>
                                    </dl>

                                    <dl>
                                        <dt>Location</dt>
                                        <dd><input type="text" name="gala_location" value="<?php echo h($gala['location']); ?>" /></dd>
                                    </dl>

                                    <dl>
                                        <dt>Date</dt>
                                        <dd><input type="date" name="gala_date" value="<?php echo h($gala['date']); ?>" /> </dd>
                                    </dl>

                                    <dl>
                                        <dt>Time </dt>
                                        <dd><input type="time" name="gala_time" value="<?php echo h($gala['time']); ?>" /></dd>
                                    </dl>
                                    <br><br>
                                    <h4>Event Details</h4>
                                    <br><br>
