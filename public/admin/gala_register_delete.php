...
if(is_post_request()) {
  $result = delete_register_by_id($id);
  $_SESSION['message'] = 'Gala Register Rejected and deleted.';
  redirect_to(url_for('admin/gala_register_view.php'));
} else {
    $delete_user = find_gala_by_id($id);
}
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form action="<?php echo url_for("/admin/gala_register_delete.php?id=" .h(u($id))); ?>" method="post">

                                    <p>Are you sure , Do you want to reject this Gala request?</p>
